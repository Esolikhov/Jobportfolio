...
def run(playwright: Playwright) -> None:
    ...
    # Пауза и выделение элемента перед кликом
    locator = page.locator("a:nth-child(3) > .auto-card__wrapper > .slider-products__links > a").first
    locator.scroll_into_view_if_needed()  # Прокрутить к элементу
    time.sleep(0.5)  # Пауза, чтобы было видно элемент
